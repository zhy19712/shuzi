...
// DB table to use
$table = 'think_safety_vehicle_management';
...
$columns = array(//定义数据库中查看的字段与表格中的哪一列相对应
    ...
    array( 'db' => 'car_number',  'dt' => 2 ),//车牌号
    array( 'db' => 'fixed_assets_number',  'dt' => 3 ),//固定资产编号
    array( 'db' => 'vehicle_category',  'dt' => 4 ),//车辆类别
    array( 'db' => 'year_limit',  'dt' => 5 ),//年审有效期
    array( 'db' => 'insurance_limit',  'dt' => 6 ),//保险有效期
    array( 'db' => 'vehicle_state',  'dt' => 7 ),//车辆状态
    array( 'db' => 'driver',  'dt' => 8 ),//驾驶员
