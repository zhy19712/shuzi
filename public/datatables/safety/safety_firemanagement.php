...
// DB table to use
$table = 'think_safety_fire_management';
...
$columns = array(//定义数据库中查看的字段与表格中的哪一列相对应
    ...
    array( 'db' => 'date_manufacture',  'dt' => 6 ),//生产日期
    array( 'db' => 'date_investment',  'dt' => 7 ),//投用日期
    array( 'db' => 'next_check_time',  'dt' => 8 ),//下次换检时间
    array( 'db' => 'serial_number',  'dt' => 9 ),//编号
